<script>
    ...
    async function createProxy() {
        ...
        let rr = {...r, status: "Disconnect", id: targetId};
    ...
    $effect(() => {
        ...
        if (params.id) {
            ...
            let tt = (t || []).find(a => a.id === params.id);
    ...
    <Form bind:this={form}>
        ...
        <div class="section">
            ...
            <div class="block colum-3">
                <Input name="name" label="Name" placeholder="input username" bind:value={inputName}/>
                <Input name="localPort" label="Local Port" type="number" placeholder="input local port"
                       bind:value={inputPort}/>
                <Input name="description" label="Description" placeholder="input description" bind:value={inputDesc}/>
            </div>
        </div>
        <div class="section">
        ...
        <div class="section">
            ...
            <div class="block colum-3">
                ...
                {#if serviceType !== 'kube'}
                    {#if serviceType === 'path'}
                        <Input name="host" label="Host" placeholder="input host" bind:value={inputTargetHost}/>
                        <Input name="port" label="Port" placeholder="input port" bind:value={inputTargetPort}/>
                    {:else}
