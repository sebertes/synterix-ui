...
import DaemonsetUpdateStrategy from "components/form/resource/DaemonsetUpdateStrategy.svelte";

export class DaemonSetSet extends Deployment {
        ...
        return [
            ...
            },
            {
                name: "spec", component: null, key: "spec", children: [
                    {name: "updateStrategy", component: DaemonsetUpdateStrategy, key: "spec.updateStrategy"},
